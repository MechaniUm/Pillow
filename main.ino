...
void SLOW_DARK_EYE() 
{
  ...
  pixels1.setPixelColor(ff, pixels.Color(0,0,0));
  pixels1.show();
  if (ff >= NUMPIXELS1)
  {
    eye_color = 0;
...
void FAST_DARK_EYE()
{
  for(f = 0; f <= NUMPIXELS; f++)
  {
    pixels.setPixelColor(f, pixels.Color(0,0,0));
    pixels.show();
  }
  for(ff = 0; f <= NUMPIXELS1; ff++)
  {
    pixels1.setPixelColor(ff, pixels1.Color(0,0,0));
    pixels1.show();
  }
}
...
void GREEN_EYE() {t9 = millis(); if(LED == false) {t10 = millis(); LED = true; f++; ff++;} if((t9 - t10) >= Int_flash_LED) LED = false; 
                   ...
                   if(f >= NUMPIXELS) f = 0; if(ff >= NUMPIXELS1) { ff = 0; eye_color = 0;}}
...
void WHITE_EYE() {t9 = millis(); if(LED == false) {t10 = millis(); LED = true; f++;} if((t9 - t10) >= Int_flash_LED) LED = false; pixels.setPixelColor(f, pixels.Color(40,40,40)); pixels.show(); if(f >= NUMPIXELS) { f = 0; eye_color = 0;} }
...
int checkSensors() {
  int tmp = 0;
  for (int i = 0; i < 4; i++) {
    if (sensorValues[i] < sensor_delta)
      tmp++;
  }
  if (tmp == 4) {
    return 0;
...
void FEAR()
{  
 if(Loop5 == false) {Loop6 = false; for(int i = 0; i <= NUMPIXELS; i++){pixels.setPixelColor(i, pixels.Color(40,0,0)); pixels.show();} 
 for(int i = 0; i <= NUMPIXELS1; i++) {pixels1.setPixelColor(i, 0, 0, 0); pixels1.show();}
...
void RELAX()
{
 if(Loop6 == false) {Loop5 = false; for(int i = 0; i <= NUMPIXELS; i++){pixels.setPixelColor(i, pixels.Color(40,0,0)); pixels.show();} 
 if(ServoSuperStart == true) {myservo1.attach(s1); myservo2.attach(s2); myservo3.attach(s3); myservo4.attach(s4);} 
 ...
 for(int i = 0; i <= NUMPIXELS; i++){pixels.setPixelColor(i, pixels.Color(0,0,40)); delay(10); pixels.show();}
 for(int i = 0; i <= NUMPIXELS1; i++) {pixels1.setPixelColor(i, 0, 0, 40); delay(10); pixels1.show();}
...
void MUSIC_AUTOMAT()
{
  ...
  if((t3 - t4) >= light_interval){t4 = 0; for(int i = 0; i <= NUMPIXELS; i++) {pixels.setPixelColor(i, 0, 0, 0); pixels.show();} for(int i = 0; i <= NUMPIXELS1; i++) {pixels1.setPixelColor(i, 0, 0, 0); pixels1.show();}}
   
  
  if(R_flash == true){t4 = millis(); red++; for(int i = 0; i <= NUMPIXELS; i++) {pixels.setPixelColor(i, 40, 0, 0); pixels.show();}
                                            for(int i = 0; i <= NUMPIXELS1; i++) {pixels1.setPixelColor(i, 0, 40, 0); pixels1.show();}
  R_flash = false; BurnLED_R = false; BurnLED_G = false; BurnLED_B = false; BurnLED_Y = false; BurnLED_O = false; BurnLED_V = false;}
  
  if(G_flash == true){t4 = millis(); green++; for(int i = 0; i <= NUMPIXELS; i++) {pixels.setPixelColor(i, 0, 40, 0); pixels.show();}
                                              for(int i = 0; i <= NUMPIXELS1; i++) {pixels1.setPixelColor(i, 0, 0, 40); pixels1.show();} 
  G_flash = false; BurnLED_R = false; BurnLED_G = false; BurnLED_B = false; BurnLED_Y = false; BurnLED_O = false; BurnLED_V = false;}
  
  if(B_flash == true){t4 = millis(); blue++; for(int i = 0; i <= NUMPIXELS; i++) {pixels.setPixelColor(i, 0, 0, 40); pixels.show();}
                                             for(int i = 0; i <= NUMPIXELS1; i++) {pixels1.setPixelColor(i, 40, 0, 0); pixels1.show();} 
  B_flash = false; BurnLED_R = false; BurnLED_G = false; BurnLED_B = false; BurnLED_Y = false; BurnLED_O = false; BurnLED_V = false;}
  
  if(O_flash == true){t4 = millis(); orange++; for(int i = 0; i <= NUMPIXELS; i++) {pixels.setPixelColor(i, 40, 40, 0); pixels.show();}
                                               for(int i = 0; i <= NUMPIXELS1; i++) {pixels1.setPixelColor(i, 0, 40, 40); pixels1.show();}  
  O_flash = false; BurnLED_R = false; BurnLED_G = false; BurnLED_B = false; BurnLED_Y = false; BurnLED_O = false; BurnLED_V = false;}
  
  if(Y_flash == true){t4 = millis(); yellow++; for(int i = 0; i <= NUMPIXELS; i++) {pixels.setPixelColor(i, 0, 40, 40); pixels.show();}
                                               for(int i = 0; i <= NUMPIXELS1; i++) {pixels1.setPixelColor(i, 40, 40, 0); pixels1.show();}                               
  Y_flash = false; BurnLED_R = false; BurnLED_G = false; BurnLED_B = false; BurnLED_Y = false; BurnLED_O = false; BurnLED_V = false;}
  
  if(V_flash == true){t4 = millis(); violet++; for(int i = 0; i <= NUMPIXELS; i++) {pixels.setPixelColor(i, 40, 0, 40); pixels.show();}
                                               for(int i = 0; i <= NUMPIXELS1; i++) {pixels1.setPixelColor(i, 0, 26, 40); pixels1.show();} 
...
void RGB_servo_show()
{
   ...
   for(int i = 0; i <= NUMPIXELS; i++) {pixels.setPixelColor(i, Rp, Bp, Gp); pixels.show();}
   for(int i = 0; i <= NUMPIXELS1; i++) {pixels1.setPixelColor(i, Rp1, Bp1, Gp1); pixels1.show();}
}
