...
void YesNoMode()
{
	...
	if (ANSWER == 2)
	{
		slave = 16; ColorEye('r'); ANSWERTIME = true; responseLoop = false; slowlyThinking = false;
	}
	if (ANSWER == 1)
	{
		slave = 15; ColorEye('g'); ANSWERTIME = true; responseLoop = false; slowlyThinking = false;
	}
